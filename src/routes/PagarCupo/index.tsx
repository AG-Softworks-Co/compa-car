   ...
   const handlePayment = async () => {
        ...
        if (!token) {
         ...
         const paymentData = {
          ...
          console.log('Data to send in /api/payments:', paymentData);
        try {
           const paymentResponse = await fetch(`https://rest-sorella-production.up.railway.app/api/payments`, {
                method: 'POST',
                headers: {
             ...
             console.log('Response from /api/payments:', paymentResponse);
           ...
           const paymentDataResponse = await paymentResponse.json();
            console.log('Response data from /api/payments:', paymentDataResponse);
             // Update reservations
            ...
            const updatedCurrentReservation = { ...currentReservation, status: 'confirmed' };
             saveToLocalStorage('currentReservation', { ...updatedCurrentReservation, payment_id: paymentDataResponse.data.payment_id });
