...
export interface TripLocation {
  ...
  export interface TripData {
    ...
    currentStep: 'origin' | 'destination' | 'routes' | 'stopovers' | 'details';
  }
  ...
  export const tripStore = {
    ...
    proceedToNextStep(): boolean {
      ...
      const currentData = this.getStoredData();
      const steps: TripData['currentStep'][] = ['origin', 'destination', 'routes', 'stopovers', 'details'];
  ...
  // Configuraciones adicionales para el mapa
